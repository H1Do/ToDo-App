var h=Object.defineProperty;var u=(r,t,e)=>t in r?h(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var i=(r,t,e)=>(u(r,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();class m{constructor(t){i(this,"model");this.model=t}handleDOMContentLoaded(){this.model.loadData()}handleBeforeUnload(){this.model.saveData()}handleTaskAddSubmit(t,e,n){n.preventDefault(),console.log(this.model),t.value&&(this.model.addTask(t.value,e.checked),t.value="")}handleClearButtonClick(){this.model.removeCompletedTasks()}handleRemoveButtonClick(t){this.model.removeTask(t)}getTasks(){return this.model.getTaskList()}getFilter(){return this.model.getFilterValue()}}class g{constructor(t,e,n){i(this,"currentTheme","dark");i(this,"containerElement");i(this,"switchThemeButton");this.currentTheme=t,this.containerElement=e,this.switchThemeButton=n}init(){this.switchThemeButton.addEventListener("click",this.switchTheme.bind(this)),this.containerElement.classList.add(`todo--${this.currentTheme}-theme`)}switchTheme(){this.currentTheme==="dark"?(this.currentTheme="light",this.containerElement.classList.remove("todo--dark-theme"),this.containerElement.classList.add("todo--light-theme")):(this.currentTheme="dark",this.containerElement.classList.remove("todo--light-theme"),this.containerElement.classList.add("todo--dark-theme"))}}class k{constructor(t){i(this,"name");this.name=t}getData(){return localStorage.getItem(this.name)?JSON.parse(localStorage.getItem(this.name)):null}setData(t){console.log(t),localStorage.setItem(this.name,JSON.stringify(t))}}class f{constructor(t,e){i(this,"filterElement");i(this,"switchCallback");i(this,"filterButtons");this.filterElement=t,this.switchCallback=e,this.filterButtons=t.querySelectorAll(".button")}initFilterSwitching(){this.filterElement.addEventListener("click",t=>{if(!(t.target instanceof HTMLButtonElement))return;const e=t.target;this.filterButtons.forEach(n=>{n.classList.remove("filter__button--selected")}),e.classList.add("filter__button--selected"),this.switchCallback(e.value)})}}class p{constructor(t,e){i(this,"switchPlaces");i(this,"taskListElement");i(this,"dragStartId",-1);this.switchPlaces=t,this.taskListElement=e}initDrag(){const t=s=>{s.target&&(this.dragStartId=Number(s.target.dataset.id),s.dataTransfer.effectAllowed="move",s.dataTransfer.setData("text/html",this.taskListElement.innerHTML))},e=s=>{s.preventDefault(),s.dataTransfer.dropEffect="move"},n=s=>{s.preventDefault();const a=s.target.closest(".task");if(!a)return;const l=Number(a.dataset.id);this.switchPlaces(l,this.dragStartId)};this.taskListElement.addEventListener("dragstart",t),this.taskListElement.addEventListener("dragover",e),this.taskListElement.addEventListener("drop",n)}}class d{constructor(t,e,n=Date.now()){i(this,"id");i(this,"description","");i(this,"isCompleted",!1);this.id=n,this.description=t,this.isCompleted=e}getDescription(){return this.description}getStatus(){return this.isCompleted}getId(){return this.id}changeStatus(){this.isCompleted=!this.isCompleted}}class _{constructor(t){i(this,"view");i(this,"taskList",[]);i(this,"filterValue","all");i(this,"storageManager");i(this,"filterManager");i(this,"dragNDropManager");i(this,"filterElement");i(this,"taskListElement");this.view=t,this.filterElement=document.querySelector(".filter"),this.taskListElement=document.querySelector(".tasks__list"),this.storageManager=new k("tasks"),this.filterManager=new f(this.filterElement,this.setFilter.bind(this)),this.filterManager.initFilterSwitching(),this.dragNDropManager=new p(this.switchPlaces.bind(this),this.taskListElement),this.dragNDropManager.initDrag()}loadData(){const t=this.storageManager.getData();t&&(t==null||t.forEach(e=>{this.taskList.push(new d(e.description,e.isCompleted,e.id))})),this.view.render()}saveData(){this.storageManager.setData(this.taskList.map(t=>({id:t.getId(),description:t.getDescription(),isCompleted:t.getStatus()})))}addTask(t,e){this.taskList.unshift(new d(t,e)),this.view.render()}removeTask(t){this.taskList=this.taskList.filter(e=>t!==e),this.view.render()}setFilter(t){this.filterValue=t,this.view.render()}removeCompletedTasks(){this.taskList=this.taskList.filter(t=>!t.getStatus()),this.view.render()}getTaskList(){return this.taskList}switchPlaces(t,e){if(t===e)return;const n=this.taskList.findIndex(l=>l.getId()===t),s=this.taskList.findIndex(l=>l.getId()===e),a=this.taskList[n];this.taskList[n]=this.taskList[s],this.taskList[s]=a,this.view.render()}getFilterValue(){return this.filterValue}}class b{constructor(t){i(this,"controller");i(this,"model");i(this,"themeButtonElement");i(this,"taskListElement");i(this,"taskInputForm");i(this,"taskInputElement");i(this,"taskInputCheckboxElement");i(this,"taskCounterElement");i(this,"taskClearButtonElement");i(this,"themeManager");this.model=new _(this),this.controller=new m(this.model),this.themeButtonElement=t.querySelector(".header__button"),this.taskListElement=t.querySelector(".tasks__list"),this.taskInputForm=t.querySelector(".tasks__input"),this.taskInputElement=t.querySelector(".tasks__input-field"),this.taskInputCheckboxElement=t.querySelector(".checkbox__input"),this.taskCounterElement=t.querySelector(".tasks__actions-count"),this.taskClearButtonElement=t.querySelector(".tasks__actions-cleanup"),this.themeManager=new g(window!=null&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",t,this.themeButtonElement),this.themeManager.init(),this.bindListeners()}bindListeners(){document.addEventListener("DOMContentLoaded",this.controller.handleDOMContentLoaded.bind(this)),window.addEventListener("beforeunload",this.controller.handleBeforeUnload.bind(this.controller)),this.taskInputForm.addEventListener("submit",this.controller.handleTaskAddSubmit.bind(this.controller,this.taskInputElement,this.taskInputCheckboxElement)),this.taskClearButtonElement.addEventListener("click",this.controller.handleClearButtonClick.bind(this))}render(){const t=new DocumentFragment,e=this.controller.getTasks(),n=this.controller.getFilter();let s=0;if(e.forEach(a=>{var l,c;if(n==="all"||n==="completed"&&a.getStatus()||n==="active"&&!a.getStatus()){s++;const o=document.createElement("li");o.innerHTML=`
      ...
      `,o.className="tasks__item task",o.dataset.id=String(a.getId()),o.setAttribute("draggable","true"),a.getStatus()&&o.classList.add("task--completed"),(l=o.querySelector(".checkbox__input"))==null||l.addEventListener("change",()=>{a.changeStatus(),this.render()}),(c=o.querySelector(".task__delete-button"))==null||c.addEventListener("click",this.controller.handleRemoveButtonClick.bind(this,a)),t.append(o)}}),!s){const a=document.createElement("li");a.innerHTML=`
        <div class="task__description">
          No one task
        </div>
...
`;const v=document.querySelector(".todo"),L=new b(v);L.render();
